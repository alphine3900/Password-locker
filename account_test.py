...
class TestAccount(unittest.TestCase):
    ...
    def test_init(self):
        ...
        '''
        self.assertEqual(self.new_account.first_name, 'alphine')
        self.assertEqual(self.new_account.last_name, 'mutwiri')
        self.assertEqual(self.new_account.user_name, 'alvo')
        self.assertEqual(self.new_account.password, '2000')
+9
